...
public:
    ...
    void TurnRightLeft(int dir){ //Dir=+1=>Right, dir=-1=> Left
		...
		xAxis.z = xAxis.z*cos(roationSpeed*dir) - xAxis.x*sin(roationSpeed*dir);
		xAxis.x = xAxis.z*sin(roationSpeed*dir) + xAxis.x*cos(roationSpeed*dir);
    }
