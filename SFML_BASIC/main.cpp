...
{ 
	...
	GLfloat light_position[] = { -15.0, 14.0, 0.0, 0.0 };
	...
	GLfloat materialShininess[] = { 128 }; // select value between 0-128, 128=shiniest
    ...
    { 
		...
		shader.setParameter("scaledHeight", terrain.scaledHeight);
		...
		GLfloat light_position[] = { 15, 0, 10.0, 0.0 };
